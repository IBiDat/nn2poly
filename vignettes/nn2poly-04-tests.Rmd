...
#> 
#>     RuntimeError: Evaluation error: ValueError: Dimensions must be equal, but are 2 and 13 for '{{node sequential_2/layer__combined__l2/MatMul}} = MatMul[T=DT_FLOAT, transpose_a=false, transpose_b=false](IteratorGetNext, sequential_2/layer__combined__l2/strided_slice_1)' with input shapes: [?,2], [13,40]..
