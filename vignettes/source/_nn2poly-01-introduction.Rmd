...
plot(final_poly,
     ...
     color_by_feature = 3, # Color by the second column of test_x
     poly_output_index = 1,
     top_n_terms = 10)
...
# Example 2.2: Plotting the 2nd-order interaction network using mean absolute monomial values
# plot(final_poly,
#      type = "interaction_network",
#      interaction_order_network = 2,
#      metric_network = "mean_monomial_abs", # Use average monomial value across data for strength
