---
title: "nn2pr-02-using-some-tools"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{nn2pr-02-using-some-tools}
...
The data needs to be scaled, both for training the NN and for the `nn2prPKG` algorithm to work properly. In the theoretical foundation of this method, the scaling assumed is to the $[-1,1]$ interval, so we will use it: 
