...
The main objective of this package is to obtain a representation of a feed forward neural network in terms of a polynomial representation. This is achieved by applying a Taylor extension at each activation function in the neural network, and combining that with its trained weights, the coefficients of a polynomial regression are obtained.
...
![plot of chunk history](figure/nn2poly-01-history-1.png)
...
![plot of chunk comparison-y-nn](figure/nn2poly-01-comparison-y-nn-1.png)
...
```r
coeffs[1:7]
#> [1] -0.72907627 -0.20473891 -0.03913103  0.03152133  0.08722556 -0.16621825  0.29426877
```
...
![plot of chunk comparison-pr-nn](figure/nn2poly-01-comparison-pr-nn-1.png)
...
![plot of chunk potentials](figure/nn2poly-01-potentials-1.png)
...
![plot of chunk potentials](figure/nn2poly-01-potentials-2.png)
