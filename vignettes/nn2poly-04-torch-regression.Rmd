...
![](figure/nn2poly-04-unnamed-chunk-2-1.png)
...
![](figure/nn2poly-04-unnamed-chunk-3-1.png)
...
The only parameters that have to be added for nn2poly to work is the chosen limit for the polynomial order with `max_order=3`.
