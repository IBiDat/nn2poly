...
// nn2poly_algorithm
List nn2poly_algorithm(const Layers& layers, const Functions& af_list, double max_order, bool keep_layers, const Term& taylor_orders);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type max_order(max_orderSEXP);
